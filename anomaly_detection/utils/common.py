"""
Common utility functions for the anomaly detection system.
...
def setup_logging(config: Dict[str, Any]) -> None:
    ...
    Args:
        config: System configuration with log_level key
    """
...
def parse_timestamp(timestamp_str: str, 
                   formats: Optional[List[str]] = None) -> Optional[datetime.datetime]:
    """
